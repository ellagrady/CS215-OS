...
with gr.Blocks() as demo:
    ...
    with gr.Tab("SJF/SRTF/LJF"):
        ...
        arrivalTimes = gr.Textbox(label="Arrival Times (formatted as an array, ordered by process ID 1-numProcesses, contained within [], separated by commas)", interactive=True)
        burstTimes = gr.Textbox(label="Burst Times (formatted as an array, ordered by process ID 1-numProcesses, contained within [], separated by commas)", interactive=True)
